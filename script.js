...
function gallery_filter(keyword)
{
    ...
    {   
        if(keyword == null)
        {  
            images_array.push("Images/hobbies/Gurpreet/hobby-cooking-"+i+".jpg");
            images_array.push("Images/hobbies/Gurpreet/hobby-football-"+i+".jpg");
            images_array.push("Images/hobbies/Gurpreet/hobby-cycling-"+i+".jpg");
        }
        else if(keyword == 'all')
        {
            images_array.push("Images/hobbies/Gurpreet/hobby-cooking-"+i+".jpg");
        ...
        {
            images_array.push("Images/hobbies/Gurpreet/hobby-"+keyword+"-"+i+".jpg");   
        }
