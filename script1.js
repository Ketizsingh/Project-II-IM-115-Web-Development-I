...
function gallery_filter(keyword)
{
    ...
    {   
        if(keyword == null)
        {  
            images_array.push("Images/hobbies/Mohit/hobby-cricket-"+i+".jpg");
            images_array.push("Images/hobbies/Mohit/hobby-gardening-"+i+".jpg");
            images_array.push("Images/hobbies/Mohit/hobby-swimming-"+i+".jpg");
        }
        else if(keyword == 'all')
        {
            images_array.push("Images/hobbies/Mohit/hobby-cricket-"+i+".jpg");
        ...
        {
            images_array.push("Images/hobbies/Mohit/hobby-"+keyword+"-"+i+".jpg");   
        }
