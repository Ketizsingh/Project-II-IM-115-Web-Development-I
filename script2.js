...
function gallery_filter(keyword)
{
    ...
    {   
        if(keyword == null)
        {  
            images_array.push("Images/hobbies/Nikhil/hobby-boxing-"+i+".jpg");
            images_array.push("Images/hobbies/Nikhil/hobby-hiking-"+i+".jpg");
            images_array.push("Images/hobbies/Nikhil/hobby-pottery-"+i+".jpg");
        }
        else if(keyword == 'all')
        {
            images_array.push("Images/hobbies/Nikhil/hobby-boxing-"+i+".jpg");
        ...
        {
            images_array.push("Images/hobbies/Nikhil/hobby-"+keyword+"-"+i+".jpg");   
        }
